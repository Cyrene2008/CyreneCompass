...
function noteActivity(){if(mode.value!=='compass'||!settings.value.autoHide)return;clearTimeout(idleTimer);idleTimer=setTimeout(returnToBall,Math.max(3,Math.min(30,settings.value.autoHideSeconds))*1000)}
